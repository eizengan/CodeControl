...
void main() {
    ...
    vec2 v3 = vec2(x + 0.5*width, y + 0.5*height);
    vec2 v4 = vec2(x + 0.5*width, y - 0.5*height);
    ...
    float l41 = thickLineSeg(aspect, v4, v1, thickness);
    
    gl_FragColor = vec4(min(1.0, l12+l23+l34+l41));
}
